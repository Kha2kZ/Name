...
async def main():
    ...
    async def daily_reward(ctx):
        ...
        # Use atomic database operation to prevent multiple claims
        reward_result = bot._claim_daily_reward(guild_id, user_id, today)
        ...
        reward, new_cash, new_streak, old_streak = reward_result
